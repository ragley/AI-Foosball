        ...
        if msg1 is not None:
            ...
            if id in Controller.keys():
                ...
                if name == "Goal_update":
                    ...
                    data1 = struct.unpack('>l',split1)
                    data2 = struct.unpack('>l',split2)
                else:
                ...
                #sends hex ID with raw data of the message
                rods_current[msg1.arbitration_id] = str(msg1.data)
...
def sendCan():
    ...
    while True:
        ...
        if run:
            ...
            if not game_flag and not game_stop:
                game_stop = True
            
            #When the game is being played, send commands to CAN
            if game_flag and not game_stop:
